...
{
    /// <summary>Verifies representative SAF-T (PT) header and master-data parsing.</summary>
    [Fact]
    public async Task ReadAsync_ValidSaft_ReturnsMasterDataAndStructuralCounts()
    {
        const string xml = """
            ...
            <AuditFile xmlns="urn:OECD:StandardAuditFile-Tax:PT_1.04_01">
              ...
              <MasterFiles>
                ...
                <Product><ProductType>P</ProductType><ProductCode>P1</ProductCode><ProductGroup>G1</ProductGroup><ProductDescription>Produto Teste</ProductDescription></Product>
              </MasterFiles>
        ...
        Assert.Equal("Produto Teste", result.Products[0].Description);
