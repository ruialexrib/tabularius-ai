...
/// <summary>
/// Adds source-traceable SAF-T (PT) products and services to the local database.
/// </summary>
[DbContext(typeof(TabulariusDbContext))]
[Migration("20260829193000_AddSaftProducts")]
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ProductNumberCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
            },
            constraints: table =>
            {
