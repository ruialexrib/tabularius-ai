...
{
    public AiToolDefinition Definition { get; } = new("get_dossier_summary", "Obtém um resumo determinístico dos dados SAF-T persistidos no dossier selecionado. Os valores monetários são expressos em EUR e SalesInvoices representa documentos de venda/faturas de venda, não notas de venda.", new { type="object", properties=new Dictionary<string,object>(), required=Array.Empty<string>(), additionalProperties=false });
    ...
    public async Task<object> ExecuteAsync(int dossierId, JsonElement arguments, CancellationToken cancellationToken)
    {
        ...
        return new
        {
            ...
            CurrencyCode="EUR",
            CurrencySymbol="€",
            MonetaryValuesNote="Apresentar todos os valores monetários em euros (EUR/€). Não converter nem assumir outra moeda.",
            ...
            SalesInvoicesLabel="Faturas/documentos de venda",
