...
public sealed class HomeController(ISaftHeaderReader saftHeaderReader, TabulariusDbContext dbContext) : Controller
{
    ...
    /// <param name="fileName">The original uploaded file name.</param><param name="analysis">The validated SAF-T (PT) analysis.</param><param name="cancellationToken">A token used to cancel the operation.</param>
