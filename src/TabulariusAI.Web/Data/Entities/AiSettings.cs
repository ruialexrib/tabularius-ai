...
public sealed class AiSettings
{
    ...
    public string HomePrompt { get; set; } = "Escolha um dossier para explorar os dados contabilísticos com o assistente AI, ou importe um novo SAF-T (PT) para acrescentar informação à análise.";
