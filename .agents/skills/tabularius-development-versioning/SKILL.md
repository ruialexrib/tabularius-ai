...
description: Assign a distinct Tabularius AI development version when beginning repository changes and preserve stable release versions until publication.
---

# Tabularius AI development versioning

Use this skill whenever beginning work that modifies the Tabularius AI repository. Read-only investigation does not require a version change.
