...
For shared use, Tabularius AI can run with **Docker Compose**, using the ASP.NET Core application with SQL Server 2022 Express for persistent multi-user storage.
...
Open `http://localhost:8080` in your browser. SQL Server data and application logs are stored in persistent Docker volumes.
